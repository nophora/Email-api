            ...
            if (this.state.firstname.length > 3 && this.state.lastname.length > 3 && this.state.email.length > 3 && this.state.password.length > 4&&include ) {
              ...
              const data = {
                ...
                const timestemp = async () => {
                    ...
                    await fetch(`http://localhost:8080/email/register`, {
                        method: 'POST',
                        headers: {
                    ...
                    <div className="form-body">
                        ...
                        <div className="form-body-t">
                            ...
                            <div className="validate">
                                ...
                                <p style={{ color:this.state.emailerror===true?'rgb(255, 0, 0)': this.state.check === true ? 'rgb(255, 0, 0)' : this.state.email.length >= 1 && this.state.email.length <= 4 && 'rgb(255, 0, 0)' }} className="validate-me">
                                    {this.state.emailerror===true?'email already in use':this.state.picture===true? 'please choose the image':this.state.check === true ? 'please fill the form' : this.state.email.length >= 1 && this.state.email.length <= 4 ? 'minimum of 6 words required' : this.state.email.length > 4 && this.state.email.length <= 5 ? 'good' : ''}
                                </p>
                            </div>
                        </div>
